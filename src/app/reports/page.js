...
export default function ConfirmedOrdersPage() {
  ...
  const [cancelledTotalPrice, setCancelledTotalPrice] = useState(0);
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/hotels/backoffice/reports/${user.hotel_id}`, {
      ...
      const result = await response.json();
       ...
       let confirmed = 0;
       let cancelled = 0;
       let confirmedPrice = result.totel_confirmed_price;
       let cancelledPrice = result.toel_cancelled_price;
      let ordersArray = [];
      if (Array.isArray(result.data)) {
       ...
       setCancelledTotalPrice(cancelledPrice);
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-6 mb-8">
             ...
             <div className="bg-white rounded-lg shadow p-6">
               <div className="flex items-center">
                 ...
                 <div className="ml-4">
                   <p className="text-sm font-medium text-gray-600">Total Price Confirmed</p>
                   <p className="text-2xl font-bold text-gray-900">¥{confirmedTotalPrice.toLocaleString()}</p>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-white rounded-lg shadow p-6">
               <div className="flex items-center">
                 ...
                 <div className="ml-4">
                   <p className="text-sm font-medium text-gray-600">Total Price Cancelled</p>
                   <p className="text-2xl font-bold text-gray-900">¥{cancelledTotalPrice.toLocaleString()}</p>
                 </div>
               </div>
             </div>
            </div>
               ...
               <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-end">
                 <div className="flex flex-col min-w-[120px] sm:min-w-[160px]">
                   ...
                   <input
                     ...
                     className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 text-sm text-right text-gray-900"
                    ...
                    <tr>
                      <td colSpan={14} className="text-center py-8 text-gray-400">No confirmed orders found</td>
                       ...
                       <tr key={order.number_order} className="hover:bg-gray-50">
                         <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-800">
                           <a
                         ...
                         <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800">
                         ¥{order.totel_price}
                         </td>
                         <td className="hidden sm:table-cell px-3 sm:px-6 py-4 whitespace-nowrap">
